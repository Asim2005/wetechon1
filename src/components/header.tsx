    ...
    >
      <nav className="mx-auto flex h-14 w-full max-w-5xl items-center justify-between px-4">
        <div className="flex items-center gap-5">
          <a className="rounded-sm p-2 hover:bg-accent" href="/">
            <img
              src="public/images/logo box.jpg"
              style={{ width: "47px", height: "auto", borderRadius: "8px" }}
              alt="Logo"
            />
          ...
          <NavigationMenu className="hidden md:flex">
            <NavigationMenuList>
              ...
              <NavigationMenuLink asChild className="px-4">
                <a className="rounded-md p-2 hover:bg-accent" href="/Fixed Scoped Models">
                  Fixed Scoped Models
                </a>
              </NavigationMenuLink>
              <NavigationMenuLink asChild className="px-4">
...
const productLinks: LinkItem[] = [
  ...
  {
    title: "Eco System Enablement",
    href: "/Eco-System-Enablement",
...
const companyLinks: LinkItem[] = [
  {
    ...
    description: "Accelerate Product Roadmap & Drive Growth",
    icon: Users,
  },
  {
